...
[MongoDB](http://www.mongodb.org/display/DOCS/Home) is a great schema-less document oriented database. It have a lot of driver for many languages (python, ruby, perl, java, php...).
